    ...
    <Modal show={show} onHide={onHide}>
      ...
      <Modal.Body>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3 row">
            <div className="col">
              <label htmlFor="modal-comment-input" className="form-label">備註</label>
              <input className="form-control" id="modal-comment-input" rows={3} value={comment} onChange={handleCommentChange} />
            </div>
          </div>
          <Modal.Footer>
